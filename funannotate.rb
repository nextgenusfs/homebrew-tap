class Funannotate < Formula
  ...
  url "https://github.com/nextgenusfs/funannotate/archive/1.6.0.tar.gz"
  sha256 "bc3ad3fb1b0f07150b7c01a4daecbad2731de824093a5fb84a0d60b63de378ea"
  # tag "bioinformatics"
  ...
  depends_on "glimmerhmm" => :recommended
